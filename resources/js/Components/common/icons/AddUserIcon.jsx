...
const ExcelIcon = ({ type = 1, size = 18, color = 'text-white' }) => {
    return (
        <>
            {type === 1 && (
            ...
            {type === 2 && (//User com Check preenchido
            ...
            {type === 3 && ( //User com cadeado preenchido
            ...
            {type === 4 && ( //User com bloqueado não preenchido
