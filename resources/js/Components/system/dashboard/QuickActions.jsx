  ...
  return (
    <>
      <div className="rounded-2xl border dark:border-red-950/50 border-gray-50/90 bg-white p-4 shadow-md ring-1 ring-black/5 dark:bg-[#0b0b0b] dark:ring-black/30">
        <h3 className="text-sm lg:text-base font-semibold text-gray-900 mb-3 dark:text-gray-100">Ações rápidas</h3>

        <div className="flex flex-col gap-2 max-h-[360px] overflow-y-auto pr-1 text-xs lg:text-sm">
          <PrimaryButton className="w-full text-white !text-xs lg:!text-sm" onClick={() => setShowFaturaForm(true)}>
            Nova Transação
          </PrimaryButton>
          <PrimaryButton
